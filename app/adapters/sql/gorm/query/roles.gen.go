...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.ApplicationID = field.NewInt32(tableName, "application_id")
	...
	_role.InactiveDate = field.NewTime(tableName, "inactive_date")
	_role.Resources = field.NewString(tableName, "resources")
	...
	_role.ActivityLogID = field.NewString(tableName, "activity_log_id")
...
func (r *role) updateTableName(table string) *role {
	...
	r.ApplicationID = field.NewInt32(table, "application_id")
	...
	r.InactiveDate = field.NewTime(table, "inactive_date")
	r.Resources = field.NewString(table, "resources")
	...
	r.ActivityLogID = field.NewString(table, "activity_log_id")
...
func (r *role) fillFieldMap() {
	...
	r.fieldMap["inactive_date"] = r.InactiveDate
	r.fieldMap["resources"] = r.Resources
	...
	r.fieldMap["activity_log_id"] = r.ActivityLogID
}
