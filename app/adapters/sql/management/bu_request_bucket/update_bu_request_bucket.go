...
func (i *impl) UpdateBuRequestBucket(ctx context.Context, payload *model.BuRequestBucket) error {
	...
	_, err := q.WithContext(ctx).
		...
		Updates(payload)
	if err != nil {
		return eris.Wrap(err, "error occurred during UpdateBuRequestBucket")
	}
