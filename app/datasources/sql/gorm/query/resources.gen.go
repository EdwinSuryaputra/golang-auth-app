...
func newResource(db *gorm.DB, opts ...gen.DOOption) resource {
	...
	_resource.MenuID = field.NewInt32(tableName, "menu_id")
	_resource.SubmenuID = field.NewInt32(tableName, "submenu_id")
	_resource.FunctionID = field.NewInt32(tableName, "function_id")
	_resource.CreatedBy = field.NewString(tableName, "created_by")
	_resource.CreatedAt = field.NewTime(tableName, "created_at")
	_resource.UpdatedBy = field.NewString(tableName, "updated_by")
	_resource.UpdatedAt = field.NewTime(tableName, "updated_at")
	_resource.DeletedBy = field.NewString(tableName, "deleted_by")
...
func (r *resource) updateTableName(table string) *resource {
	...
	r.SubmenuID = field.NewInt32(table, "submenu_id")
	r.FunctionID = field.NewInt32(table, "function_id")
...
func (r *resource) fillFieldMap() {
	...
	r.fieldMap["submenu_id"] = r.SubmenuID
	r.fieldMap["function_id"] = r.FunctionID
