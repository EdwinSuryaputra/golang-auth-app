...
var (
	...
	BuRequestBucket     *buRequestBucket
	Function            *function
	Menu                *menu
	Resource            *resource
	Role                *role
...
func SetDefault(db *gorm.DB, opts ...gen.DOOption) {
	*Q = *Use(db, opts...)
	...
	BuRequestBucket = &Q.BuRequestBucket
	Function = &Q.Function
	Menu = &Q.Menu
	Resource = &Q.Resource
	Role = &Q.Role
...
func Use(db *gorm.DB, opts ...gen.DOOption) *Query {
	return &Query{
		...
		BuRequestBucket:     newBuRequestBucket(db, opts...),
...
func (q *Query) clone(db *gorm.DB) *Query {
	return &Query{
		...
		BuRequestBucket:     q.BuRequestBucket.clone(db),
...
func (q *Query) ReplaceDB(db *gorm.DB) *Query {
	return &Query{
		...
		BuRequestBucket:     q.BuRequestBucket.replaceDB(db),
...
type queryCtx struct {
	...
	BuRequestBucket     IBuRequestBucketDo
...
func (q *Query) WithContext(ctx context.Context) *queryCtx {
	return &queryCtx{
		...
		BuRequestBucket:     q.BuRequestBucket.WithContext(ctx),
