...
func newMenu(db *gorm.DB, opts ...gen.DOOption) menu {
	...
	_menu.ApplicationID = field.NewInt32(tableName, "application_id")
	_menu.Name = field.NewString(tableName, "name")
	_menu.PublicName = field.NewString(tableName, "public_name")
	_menu.Description = field.NewString(tableName, "description")
	_menu.CreatedBy = field.NewString(tableName, "created_by")
	_menu.CreatedAt = field.NewTime(tableName, "created_at")
	_menu.UpdatedBy = field.NewString(tableName, "updated_by")
	_menu.UpdatedAt = field.NewTime(tableName, "updated_at")
	_menu.DeletedBy = field.NewString(tableName, "deleted_by")
...
func (m *menu) updateTableName(table string) *menu {
	...
	m.ApplicationID = field.NewInt32(table, "application_id")
	m.Name = field.NewString(table, "name")
	m.PublicName = field.NewString(table, "public_name")
...
func (m *menu) fillFieldMap() {
	...
	m.fieldMap["id"] = m.ID
	m.fieldMap["application_id"] = m.ApplicationID
	m.fieldMap["name"] = m.Name
	m.fieldMap["public_name"] = m.PublicName
